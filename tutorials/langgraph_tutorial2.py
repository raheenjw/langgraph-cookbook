...
load_dotenv()
#start->classifier->router->logical or therapist (2 ai agents)->end 
llm=init_chat_model(
...
def classify_message(state:State):
    ...
    classifier_llm= llm.with_structured_output(MessageClassifier) #the llm will tell us whether we require a logical or emotional response
